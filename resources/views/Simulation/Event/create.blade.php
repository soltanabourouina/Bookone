...
@section('title', "Ajouter un évenement a $simulation->code")

@section('content')
    <div class="w-25 m-auto">
        @include('alerts')
        <form action="{{ route('createSimulationEventPOST', $simulation->id) }}" method="POST">
            @csrf
            ...
            <div id="group-GENERAL_RAISE" class="d-none selector-group">
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group mb-3">
                                <label for="GENERAL_RAISE_EXCEPT">Sauf (réference)</label>
                                <input type="text" class="form-control" name="GENERAL_RAISE_EXCEPT" id="GENERAL_RAISE_EXCEPT" placeholder="Sauf (réference)">
                            </div>
                        </div> 
                        --}}
                    </div>
            ...
            <div class="mb-3 text-end">
                <a href="{{route('readSimulationGET', $simulation->id)}}" class="btn btn-danger">Annuler</a>

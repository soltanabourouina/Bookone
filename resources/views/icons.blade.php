...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Icons</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Icons</span>
						</div>
					</div>
						...
						<div class="card custom-card">
							<div class="card-body">
								...
								<div class="main-icon-group main-icon-list simple-icons">
									<ul class="icons-list">
										<li class="icons-list-item"><i class="ti-arrow-up"></i></li>
										<li class="icons-list-item"><i class="ti-arrow-right"></i></li>
										<li class="icons-list-item"><i class="ti-arrow-left"></i></li>
										<li class="icons-list-item"><i class="ti-arrow-down"></i></li>
										<li class="icons-list-item"><i class="ti-arrows-vertical"></i></li>
										<li class="icons-list-item"><i class="ti-arrows-horizontal"></i></li>
										<li class="icons-list-item"><i class="ti-angle-up"></i></li>
										<li class="icons-list-item"><i class="ti-angle-right"></i></li>
										<li class="icons-list-item"><i class="ti-angle-left"></i></li>
										<li class="icons-list-item"><i class="ti-angle-down"></i></li>
										<li class="icons-list-item"><i class="ti-angle-double-up"></i></li>
										<li class="icons-list-item"><i class="ti-angle-double-right"></i></li>
										<li class="icons-list-item"><i class="ti-angle-double-left"></i></li>
										<li class="icons-list-item"><i class="ti-angle-double-down"></i></li>
										<li class="icons-list-item"><i class="ti-move"></i></li>
										<li class="icons-list-item"><i class="ti-fullscreen"></i></li>
										<li class="icons-list-item"><i class="ti-arrow-top-right"></i></li>
										<li class="icons-list-item"><i class="ti-arrow-top-left"></i></li>
										<li class="icons-list-item"><i class="ti-arrow-circle-up"></i></li>
										<li class="icons-list-item"><i class="ti-arrow-circle-right"></i></li>
										<li class="icons-list-item"><i class="ti-arrow-circle-left"></i></li>
										<li class="icons-list-item"><i class="ti-arrow-circle-down"></i></li>
										<li class="icons-list-item"><i class="ti-arrows-corner"></i></li>
										<li class="icons-list-item"><i class="ti-split-v"></i></li>
										<li class="icons-list-item"><i class="ti-split-v-alt"></i></li>
									</ul>
								</div>
							</div>
						</div>
							...
							<div class="card-body">
								...
								<div class="main-icon-group main-icon-list simple-icons">
									<ul class="icons-list">
										...
										<li class="icons-list-item"><i class="cf cf-xem"></i></li>

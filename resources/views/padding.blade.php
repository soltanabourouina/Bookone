...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Utilities</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Padding</span>
						</div>
					</div>
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="d-md-flex">
									...
									<div class="wd-200 ht-100 bg-gray-500 mr-md-4 pd-l-50 mt-4 mt-xl-0">
										<div class="d-flex align-items-center justify-content-center ht-100p bg-gray-400">
											.pd-l-50
										</div>
									</div>
									<div class="wd-200 ht-100 bg-gray-500 mr-md-4 pd-l-120 mt-4 mt-xl-0">
										<div class="d-flex align-items-center justify-content-center ht-100p bg-gray-400">
											.pd-l-120
										</div>
									</div>
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="d-md-flex">
									...
									<div class="wd-200 ht-100 bg-gray-500 mr-md-4 pd-r-50 mt-4 mt-xl-0">
										<div class="d-flex align-items-center justify-content-center ht-100p bg-gray-400">
											.pd-r-50
										</div>
									</div>
									<div class="wd-200 ht-100 bg-gray-500 mr-md-4 pd-r-120 mt-4 mt-xl-0">
										<div class="d-flex align-items-center justify-content-center ht-100p bg-gray-400">
											.pd-r-120
										</div>
									</div>
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="d-md-flex">
									...
									<div class="wd-200 ht-100 bg-gray-500 mr-md-4 pd-b-50 mt-4 mt-xl-0">
										<div class="d-flex align-items-center justify-content-center ht-100p bg-gray-400">
											.pd-b-50
										</div>
									</div>
									<div class="wd-200 ht-100 bg-gray-500 mr-md-4 pd-b-70 mt-4 mt-xl-0">
										<div class="d-flex align-items-center justify-content-center ht-100p bg-gray-400">
											.pd-b-70
										</div>
									</div>

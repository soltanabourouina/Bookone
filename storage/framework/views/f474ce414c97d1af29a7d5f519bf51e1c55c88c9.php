                ...
                <form action="<?php echo e(route('users.destroy', 'test')); ?>" method="post">
                    ...
                    <div class="modal-body">
                       ...
                       <div class="alert alert-danger" role="alert">
                        <p color="danger">vous etes sur le point de supprimer définitivement l'utilisateur suivant!
                            <br>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/soltana/Bureau/spatie/invoices/resources/views/users/show_users.blade.php ENDPATH**/ ?>
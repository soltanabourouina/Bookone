...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">Permissions</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Modifier les permissions</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                        <button type="submit" class="btn btn-main-primary">Modififer</button>
                    </div>
                    <!-- /col -->
                </div>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/soltana/Bureau/spatie/invoices/resources/views/roles/edit.blade.php ENDPATH**/ ?>
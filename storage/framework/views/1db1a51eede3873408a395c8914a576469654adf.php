									...
									<div class="main-content-left main-content-left-contacts">
										...
										<div class="main-contacts-list" id="mainContactList">
											...
											<div class="main-contact-item selected">
												<div class="main-img-user online"><img alt="avatar" src="<?php echo e(URL::asset('assets/img/faces/2.jpg')); ?>"></div>
											...
											<div class="main-contact-item">
												<div class="main-img-user"><img alt="avatar" src="<?php echo e(URL::asset('assets/img/faces/3.jpg')); ?>"></div>
												<div class="main-contact-body">
											...
											<div class="main-contact-item">
												<div class="main-img-user"><img alt="avatar" src="<?php echo e(URL::asset('assets/img/faces/4.jpg')); ?>"></div>
												<div class="main-contact-body">
											...
											<div class="main-contact-item">
												<div class="main-img-user online"><img alt="avatar" src="<?php echo e(URL::asset('assets/img/faces/5.jpg')); ?>"></div>
												<div class="main-contact-body">
											...
											<div class="main-contact-item">
												<div class="main-img-user"><img alt="avatar" src="<?php echo e(URL::asset('assets/img/faces/6.jpg')); ?>"></div>
												<div class="main-contact-body">
											...
											<div class="main-contact-item">
												<div class="main-img-user online"><img alt="avatar" src="<?php echo e(URL::asset('assets/img/faces/7.jpg')); ?>"></div>
												<div class="main-contact-body">
											...
											<div class="main-contact-item">
												<div class="main-img-user online"><img alt="avatar" src="<?php echo e(URL::asset('assets/img/faces/8.jpg')); ?>"></div>
												<div class="main-contact-body">
											...
											<div class="main-contact-item">
												<div class="main-img-user online"><img alt="avatar" src="<?php echo e(URL::asset('assets/img/faces/9.jpg')); ?>"></div>
												<div class="main-contact-body">
											...
											<div class="main-contact-item">
												<div class="main-img-user"><img alt="avatar" src="<?php echo e(URL::asset('assets/img/faces/10.jpg')); ?>"></div>
												<div class="main-contact-body">
											...
											<div class="main-contact-item">
												<div class="main-img-user online"><img alt="avatar" src="<?php echo e(URL::asset('assets/img/faces/11.jpg')); ?>"></div>
												<div class="main-contact-body">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/soltana/Bureau/spatie/invoices/resources/views/contacts.blade.php ENDPATH**/ ?>